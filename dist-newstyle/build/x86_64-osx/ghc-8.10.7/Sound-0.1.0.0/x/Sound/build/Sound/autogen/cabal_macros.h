...
/* package Sound-0.1.0.0 */
#ifndef VERSION_Sound
#define VERSION_Sound "0.1.0.0"
#endif /* VERSION_Sound */
#ifndef MIN_VERSION_Sound
#define MIN_VERSION_Sound(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Sound */
...
#define CURRENT_COMPONENT_ID "Sound-0.1.0.0-inplace-Sound"
